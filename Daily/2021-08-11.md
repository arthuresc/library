...
- **Resultado: O Selenium usa dos elementos HTML para entender e achar aonde foi feito o evento do JS, acontece que no final quando ele tentar testar a rotina criada ele não encontra o pseudo-elemento ** 