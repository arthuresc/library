...
## Criando sub-repositório ou os __Sub Modulos__

## Mensagens de commit

Um bom exemplo de mensagem de commit seria baseado na [Conventional Commits](https://www.conventionalcommits.org/pt-br/v1.0.0-beta.4/#resumo) que enquanto escrevo aqui está na versão `1.0.0-beta.4`
