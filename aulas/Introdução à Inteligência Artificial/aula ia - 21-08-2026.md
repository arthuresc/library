...
- Época: é quantidade de vezes que você realiza faz a back propagation
- TAxa de aprendizagem: é quantidade de vezes 
- Back propagation é quando você "repassa" as informações voltando o caminho dos neurônios para que seja refeito a estratégia aplicada de aprendizagem pelos neurônios do modelo, nisso é feito o recalculo de entradas erradas e aumentando a importancia de entrada certas ou mais corretas
- 

## O que não entendi:

- z-score (é um calculo de derivativa)
- perceptron (uma lógica de sistema de deep learning, é literalmente o código de calculo e lógica)
